  ...
  return (
    <><section id="hero" className={styles.container}>
        ...
        <div className={styles.info}>
            ...
            <span><a href="https://github.com/" target='_blank'><img src={githubIcon} alt="github icon" /></a><a href="https://linkedin.com/" target='_blank'><img src={linkedinIcon} alt="linkedin icon" /></a></span>
